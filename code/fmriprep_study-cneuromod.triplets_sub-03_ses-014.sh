...
#SBATCH --output=/lustre04/scratch/bpinsard/triplets.fmriprep/code/fmriprep_study-cneuromod.triplets_sub-03_ses-014.out
#SBATCH --error=/lustre04/scratch/bpinsard/triplets.fmriprep/code/fmriprep_study-cneuromod.triplets_sub-03_ses-014.err
