...
#SBATCH --job-name=fmriprep_study-cneuromod.triplets_sub-03_ses-014.job
#SBATCH --output=/lustre04/scratch/bpinsard/cneuromod.triplets.fmriprep/code/fmriprep_study-cneuromod.triplets_sub-03_ses-014.out
#SBATCH --error=/lustre04/scratch/bpinsard/cneuromod.triplets.fmriprep/code/fmriprep_study-cneuromod.triplets_sub-03_ses-014.err
...
if [ -e $LOCAL_DATASET/workdir/fmriprep_wf/resource_monitor.json ] ; then cp $LOCAL_DATASET/workdir/fmriprep_wf/resource_monitor.json /scratch/bpinsard/fmriprep_study-cneuromod.triplets_sub-03_ses-014_resource_monitor.json ; fi 
if [ $fmriprep_exitcode -ne 0 ] ; then cp -R $LOCAL_DATASET /scratch/bpinsard/fmriprep_study-cneuromod.triplets_sub-03_ses-014 ; fi 
